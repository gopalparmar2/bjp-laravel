...
rangeAreaChartColors &&
    ((options = {
        ...
        title: { text: "New York Temperature (all year round)" },
    ...
    (dumbbellColumnChartsColors = getChartColorsArray(
        ...
        ((options = {
            ...
            chart: { height: 390, type: "rangeBar", zoom: { enabled: !1 } },
